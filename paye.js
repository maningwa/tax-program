...
const rates20_covid = [
    ...
    {band: 2,rate: 0.15 ,lower: taxablemin,                 upper: taxablemin + bandsize   },
    {band: 2,rate: 0.20 ,lower: taxablemin + bandsize,      upper: taxablemin + (bandsize*2)},
    {band: 3,rate: 0.25 ,lower: taxablemin + (bandsize*2),  upper: Infinity                 },
]
///KRA PAYE Rates unde the Finance ACT 2021 till 2021
const rates21_23 = [
    {band: 0,rate: 0.1  ,lower: 0,                          upper: taxablemin                   },
    {band: 2,rate: 0.25 ,lower: taxablemin,                 upper: taxablemin + (bandsize)        },
    {band: 3,rate: 0.3  ,lower: taxablemin + (bandsize),    upper: Infinity                     },
]
/// KRA PAYEE Rates under the FINANCE ACT 2023
const rates23 = [
    {band: 0,rate: 0.1  ,lower: 0,                          upper: taxablemin                   },
    {band: 2,rate: 0.25 ,lower: taxablemin,                 upper: taxablemin + (bandsize)        },
    {band: 3,rate: 0.3  ,lower: taxablemin + (bandsize),    upper: 300000                       },
